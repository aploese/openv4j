 ...
 * @author aploese
 */
public enum DataPoint implements Serializable {
    ...
    // M1
    //DHW
    DHW_CYCLE_MON_TIMES(0x2100, Group.DHW, CYCLES_HEATING, MONDAY, CYCLE_TIMES, AccessType.RW),
    ...
    M1_TIMER_HEATUP(0x2502, Group.M1, CONFIG, HEATUP_TIME, UINT_4, AccessType.RO, 0.1),
    M1_STATE_FROST(0x2506, Group.M1, STATE, FROST, BOOL, AccessType.RO),
    ...
    BOILER_CONFIG_BURNER_TYPE(0x5702, Group.BOILER, CONFIG, Property.C2_02, UINT_1, AccessType.RW),
    BOILER_CONFIG_C2_03(0x5703, Group.M2, CONFIG, C2_03, UINT_1, AccessType.RW),
...
//    Codierung 82 - 87 liegt auf 2 bis 7
    ...
    //0xe000 to 0xefff
    //0xf000 to 0xffff
    final static public int BLOCKS[] = {
        ...
        0x2000,
        0x2010, 0x2020, 0x2030,
        0x2100, 0x2110, 0x2120, 0x2130,
        0x2200, 0x2210, 0x2220, 0x2230,
        0x2300, 0x2310,
        0x2500, 0x2510, 0x2520, 0x2530, 0x2540,
        0x27a0, 0x27b0, 0x27c0, 0x27e0, 0x27f0,
        0x2900, 0x3000, 0x3010, 0x3020, 0x3030,
        0x3100, 0x3110, 0x3120, 0x3130,
        0x3200, 0x3210, 0x3220, 0x3230,
        0x3300, 0x3310,
        0x3500, 0x3510, 0x3520, 0x3530, 0x3540,
        0x37a0, 0x37b0, 0x37c0, 0x37e0, 0x37f0,
        0x3900,
        0x4000, 0x4010, 0x4020, 0x4030,
        0x4100, 0x4110, 0x4120, 0x4130, 0x4200,
        0x4210, 0x4220, 0x4230,
        0x4300, 0x4310,
        0x4500, 0x4510, 0x4520, 0x4530, 0x4540,
        0x47a0, 0x47b0, 0x47c0, 0x47e0, 0x47f0,
        0x4900,
        0x5300,
        0x5500, 0x5510, 0x5520, 0x5530,
        0x5700, 0x5710, 0x5720, 0x5730,
        0x57a0, 0x57d0, 0x57f0,
        0x6300,
        0x6500, 0x6510,
        0x6750, 0x6760, 0x6770,
        0x6900,
        0x7300, 0x7310, 0x7320, 0x7330, 0x7340,
        0x7500, 0x7510, 0x7520, 0x7530, 0x7540, 0x7550, 0x7560, 0x7570,
        0x7700,
        0x7770, 0x7780, 0x7790,
        0x7900};
    ...
    final private PropertyType valueKind;
    final private Property value;
    final private DataType type;
    final private AccessType access;
    final private double factor;
    final private Alternative alternative;
